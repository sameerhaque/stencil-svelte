...
var RecaptchaExample = /** @class */ (function () {
    function RecaptchaExample(hostRef) {
        registerInstance(this, hostRef);
        this.captchas = Array();
        this.siteKey = '6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI';
    }
    RecaptchaExample.prototype.componentDidLoad = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, WebUtils.sleep(500)];
                    case 2:
                        _a.sent();
                        this.captchas = __spreadArrays(this.captchas, [
    ...
    RecaptchaExample.prototype.render = function () {
        return (h("div", null, this.captchas));
    };
    return RecaptchaExample;
}());
