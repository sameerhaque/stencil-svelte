...
var AccordionExample = /** @class */ (function () {
    function AccordionExample(hostRef) {
        registerInstance(this, hostRef);
    }
    AccordionExample.prototype.componentDidLoad = function () {
        var modal = document.querySelector("snt-modal#modal-1");
        if (modal) {
            modal.show();
        }
    };
    AccordionExample.prototype.render = function () {
        return [
