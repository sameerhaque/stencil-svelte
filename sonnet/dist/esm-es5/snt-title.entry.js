...
var TitleComponent = /** @class */ (function () {
    function TitleComponent(hostRef) {
        registerInstance(this, hostRef);
        this.clampLines = 0;
        this.truncationString = "...";
    }
    TitleComponent.prototype.getContent = function (titleType) {
        var _this = this;
        switch (titleType) {
            case TitleTypeEnum.h1: return (h("h1", { ref: function (el) { _this.titleElement = el; }, class: "header" }, h("slot", null)));
            case TitleTypeEnum.h2: return (h("h2", { ref: function (el) { _this.titleElement = el; }, class: "header" }, h("slot", null)));
            case TitleTypeEnum.h3: return (h("h3", { ref: function (el) { _this.titleElement = el; }, class: "header" }, h("slot", null)));
            case TitleTypeEnum.h4: return (h("h4", { ref: function (el) { _this.titleElement = el; }, class: "header" }, h("slot", null)));
            default: return "";
        }
    };
    TitleComponent.prototype.componentDidRender = function () {
    ...
    TitleComponent.prototype.clampTitle = function (clampLines) {
        if (clampLines === void 0) { clampLines = this.clampLines; }
    ...
    TitleComponent.prototype.setTitle = function (title) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    TitleComponent.prototype.render = function () {
        var content = this.getContent(this.titleType);
        return [
