...
var VideoComponent = /** @class */ (function () {
    function VideoComponent(hostRef) {
        registerInstance(this, hostRef);
    }
    VideoComponent.prototype.componentWillLoad = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.processOembed()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    VideoComponent.prototype.processOembed = function () {
        return __awaiter(this, void 0, void 0, function () {
            var fullOembedUrl;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fullOembedUrl = this.getFullOembedUrl(this.shareUrl, this.oembedUrl, this.playUrl);
                        return [4 /*yield*/, axios$1.get(fullOembedUrl).then(function (oembedResponse) {
                                var docFragment = _this.getDocumentFragmentFromHtmlString(oembedResponse.data.html);
                                var playerEmbed = _this.getPlayerEmbed(docFragment);
                                _this.playerScript = _this.getPlayerScript(docFragment);
                                //Vidyard embed code that gets replaced with the iFrame                        
                                _this.playerEmbed = h("div", { class: "player-embed", innerHTML: playerEmbed.outerHTML });
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    VideoComponent.prototype.componentDidLoad = function () {
    ...
    VideoComponent.prototype.getFullOembedUrl = function (shareUrl, oembedUrl, playUrl) {
        var uuid = shareUrl.match(/[^\/]+$/);
        var fullPlayUrl = playUrl + '/' + uuid;
        return oembedUrl + "?url=" + fullPlayUrl + "&format=json";
    };
    VideoComponent.prototype.getDocumentFragmentFromHtmlString = function (htmlString) {
        var domParser = new DOMParser();
        return domParser.parseFromString(htmlString, 'text/html');
    };
    VideoComponent.prototype.getPlayerScript = function (docFragment) {
        var playerScript = document.createElement("script");
        var unexecutablePlayerScrupt = docFragment.querySelector('script');
    ...
    VideoComponent.prototype.getPlayerEmbed = function (docFragment) {
        var playerEmbed = docFragment.querySelector('.vidyard-player-embed');
    ...
    Object.defineProperty(VideoComponent.prototype, "element", {
...
VideoComponent.style = videoComponentCss;
export { VideoComponent as snt_video };
