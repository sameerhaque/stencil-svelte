...
var FormComponent = /** @class */ (function () {
    function FormComponent(hostRef) {
     ...
     * Methods
     */
    FormComponent.prototype.openErrorModal = function (actionData, modalId) {
    ...
    FormComponent.prototype.openSuccessModal = function (actionData, modalId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    FormComponent.prototype.componentDidLoad = function () {
        var _this = this;
    ...
    FormComponent.prototype.onChangeInputBlankHandler = function (event) {
    ...
    FormComponent.prototype.onChangeValueFormElementHandler = function (event) {
        FormService.process(event);
        event.preventDefault();
    };
    FormComponent.prototype.onBlurFormElementHandler = function (event) {
        var _element = event.target;
    ...
    FormComponent.prototype.onInvalidateFormElementHandler = function (event) {
        FormService.process(event);
        event.preventDefault();
    };
    FormComponent.prototype.getPayload = function () {
        var _this = this;
        var _result = {};
        var _elements = this.getFormElements();
        _elements.forEach(function (_element) {
    ...
    FormComponent.prototype.submitForm = function (e) {
        this.formSubmit.emit(e);
        e.preventDefault();
    };
    FormComponent.prototype.getFormElements = function () {
    ...
    FormComponent.prototype.getPayloadNameForElement = function (element) {
