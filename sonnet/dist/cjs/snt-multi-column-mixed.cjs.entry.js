...
const MultiColumnComponent = class {
    ...
    getViewport() {
        const viewportBreakpoints = [
            { breakpoint: ComponentConstants.ComponentConstants.EXTRA_LARGE.getLeft(), viewport: 'extra-large' },
            { breakpoint: ComponentConstants.ComponentConstants.LARGE.getLeft(), viewport: 'large' },
            { breakpoint: ComponentConstants.ComponentConstants.MEDIUM.getLeft(), viewport: 'medium' },
            { breakpoint: ComponentConstants.ComponentConstants.SMALL.getLeft(), viewport: 'small' },
            { breakpoint: ComponentConstants.ComponentConstants.EXTRA_SMALL.getLeft(), viewport: 'extra-small' }
        ];
    ...
    render() {
        return (index.h(index.Host, { class: WebUtils.WebUtils.generateClasses([], this.styleClasses) }, index.h("snt-layout", { ref: (el) => this.layoutEl = el }, index.h("div", { class: "row", ref: el => this.flexGrid = el }, index.h("slot", null)))));
    }
...
exports.snt_multi_column_mixed = MultiColumnComponent;
