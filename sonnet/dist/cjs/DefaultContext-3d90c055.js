...
var mustache = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
class ViewportConfigurationService {
    ...
    register(target, _nodes, callback) {
        const mediaQueryInstances = WebUtils.WebUtils.getMediaQueryInstances();
...
exports.ViewportAttributesBuilder = ViewportAttributesBuilder;
exports.ViewportConfigurationService = ViewportConfigurationService;
exports.ViewportParameterBuilder = ViewportParameterBuilder;
exports.ViewportParameters = ViewportParameters;
