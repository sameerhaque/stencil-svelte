    ...
    toggleModal(shown) {
        return __awaiter(this, void 0, void 0, function* () {
            if (shown) {
                ...
                yield WebUtils.WebUtils.sleep(WebUtils.WebUtils.getTransitionDuration(this.element));
                if (this.options.backdrop) {
                    this.backdropElement.classList.add(ModalComponent.CLASS_SHOW);
                    yield WebUtils.WebUtils.sleep(WebUtils.WebUtils.getTransitionDuration(this.backdropElement));
                }
