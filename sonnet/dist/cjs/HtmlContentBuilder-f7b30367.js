...
class AbstractContentBuilder {
    ...
    withConditionalStringArgument(fn, arg) {
        return (StringUtils.StringUtils.notEmpty(arg)) ? this.withConditionalArguments(fn, arg) : this;
    }
...
class HtmlContentBuilder extends AbstractUrlContentBuilder {
    ...
    build() {
        ...
        return __awaiter$1(this, void 0, void 0, function* () {
            ...
            if (StringUtils.StringUtils.isEmpty(this.value) && this.url) {
                this.parentElement.appendChild(yield _super.build.call(this));
            }
            else if (StringUtils.StringUtils.notEmpty(this.value)) {
...
exports.AbstractUrlContentBuilder = AbstractUrlContentBuilder;
exports.HtmlContentBuilder = HtmlContentBuilder;
