...
describe("feature-right-component", () => {
    const specPageOptions = {
        components: [FeatureRightComponent],
        html: `<snt-feature-right img-src='https://www.sonnet.ca/_Sonnet/images/page-specific/featured-blog/make-sure-youre-covered-tablet-1x.jpg'
