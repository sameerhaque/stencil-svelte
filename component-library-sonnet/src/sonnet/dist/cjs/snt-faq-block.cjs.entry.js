...
const FAQBlockComponent = class {
    ...
    render() {
        return [
            index.h("a", { href: this.blockLink }, index.h("div", { class: "faq-block-wrapper" }, index.h("h3", null, this.titleText), index.h("div", { class: "faq-block-body" }, this.bodyText), index.h("div", { class: "faq-articles-count" }, this.articlesCount)))
        ];
    }
};
...
exports.snt_faq_block = FAQBlockComponent;
