...
const VideoComponent = class {
    ...
    async processOembed() {
        ...
        await axios$1.get(fullOembedUrl).then((oembedResponse) => {
            ...
            this.playerEmbed = index.h("div", { class: "player-embed", innerHTML: playerEmbed.outerHTML });
        });
    }
    componentDidLoad() {
    ...
    render() {
        return (index.h("snt-layout", null, index.h("div", { class: "intro" }, index.h("h3", { class: "headline" }, this.headline), index.h("slot", { name: "description" })), this.playerEmbed, this.transcriptSummaryOpen && this.transcriptSummaryClose
            ? index.h("snt-accordion", { class: "transcript-accordion", id: `${this.element.id}-accordion` }, index.h("div", { slot: "summary" }, index.h("span", { class: "transcript-summary-open" }, this.transcriptSummaryOpen), index.h("span", { class: "transcript-summary-close" }, this.transcriptSummaryClose)), index.h("div", { slot: "details" }, index.h("slot", { name: "transcript-details" })))
            : null));
    }
...
exports.snt_video = VideoComponent;
