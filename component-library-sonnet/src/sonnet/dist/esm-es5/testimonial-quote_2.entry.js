...
var TestimonialsGroupComponent = /** @class */ (function () {
    ...
    class_1.prototype.unify = function (e) { return e.changedTouches ? e.changedTouches[0] : e; };
    ;
    class_1.prototype.lock = function (e) {
        this.x0 = this.unify(e).clientX;
    };
    ;
    class_1.prototype.move = function (e) {
    ...
    class_1.prototype.getPrevNextButtons = function () {
        var _this = this;
    ...
    class_1.prototype.getSlideElements = function () {
        this.slideElements = this.element.querySelectorAll(this.slideSelector);
    };
    class_1.prototype.getIndicatorElements = function () {
        var _this = this;
    ...
    class_1.prototype.addClickHandler = function (element, fn) {
    ...
    class_1.prototype.indicatorClickHandler = function (element, index) {
        var _this = this;
        if (!element)
            return;
        var eventHandler = function () {
    ...
    class_1.prototype.addActiveClass = function (element) {
    ...
    class_1.prototype.removeActiveClass = function (elements) {
    ...
    class_1.prototype.onShow = function (index) {
    ...
    class_1.prototype.onHide = function (index) {
        if (index === void 0) { index = 0; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.removeActiveClass();
