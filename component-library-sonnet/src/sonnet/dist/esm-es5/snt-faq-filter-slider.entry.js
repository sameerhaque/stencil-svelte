...
var FAQFilterSliderComponent = /** @class */ (function () {
    ...
    FAQFilterSliderComponent.prototype.render = function () {
        var _this = this;
        return [
            h("host", { class: this._filterArr.length === 0 ? "hide" : "" }, h("snt-layout", null, h("div", { class: "wrapper" }, h("div", { class: "right-gradient" }), h("div", { class: "left-gradient" }), h("div", { class: "filter-container" }, h("nav", { "aria-label": this.menuAriaLabel }, h("ul", null, this._filterArr.map(function (item) { return (h("li", null, h("a", { href: "javascript:void(0)", class: item.key == _this.currentActive ? "active" : "", onClick: _this.onFilterClick.bind(_this, item.key) }, item.title), h("span", { class: "bold-hidden" }, item.title))); })))))))
        ];
    };
    return FAQFilterSliderComponent;
}());
