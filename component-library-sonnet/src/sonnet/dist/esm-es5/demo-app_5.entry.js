...
var DemoApp = /** @class */ (function () {
    ...
    DemoApp.prototype.render = function () {
        ...
        var routesLinkMarkup, routeMarkup;
        var navClassList = 'list-group-item list-group-item-action bg-light';
        routesLinkMarkup = routesCollection.routes.map(function (el) {
            return h("stencil-route-link", { url: el.linkUrl, anchorClass: navClassList }, el.linkText);
        });
        routeMarkup = routesCollection.routes.map(function (el) {
            return el.exact
