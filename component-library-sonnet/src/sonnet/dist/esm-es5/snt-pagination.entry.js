...
var FAQPaginationComponent = /** @class */ (function () {
    ...
    class_1.prototype.onPageNumberClick = function (pageNum) {
        if (this.curr !== pageNum) {
            this.curr = pageNum;
            this.pageChanged.emit(this.curr.toString());
        }
    };
    class_1.prototype.onPreviousClick = function () {
        if (this.curr > 1) {
            this.curr--;
            this.pageChanged.emit(this.curr.toString());
        }
    };
    class_1.prototype.onNextClick = function () {
        if (this.curr < this.totalPages) {
            this.curr++;
            this.pageChanged.emit(this.curr.toString());
        }
    };
    class_1.prototype.setPageNumber = function (pageNum, emitEvent) {
    ...
    class_1.prototype.getPageLink = function (pageNum) {
    ...
    class_1.prototype.getEllipsis = function () {
        return h("span", { class: "page-number" }, this.ellipsis);
    };
    class_1.prototype.getPageNumbersForDesktop = function () {
