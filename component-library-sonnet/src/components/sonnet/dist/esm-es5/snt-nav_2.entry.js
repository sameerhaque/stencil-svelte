...
var NavItemComponent = /** @class */ (function () {
    ...
    class_1.prototype.toggleExpanded = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    class_1.prototype.setCurrent = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.current = true;
                return [2 /*return*/];
    ...
    class_1.prototype.unsetCurrent = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.current = false;
                return [2 /*return*/];
    ...
    class_1.prototype.toggleCurrent = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    class_1.prototype.watchCurrent = function () {
        if (this.parent) {
    ...
    class_1.prototype.watchExpanded = function () {
        if (this.type == NavItemTypeEnum.SUBNAV) {
            this.navItemEvent.emit();
        }
    };
    class_1.prototype.registerParent = function (parent) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.parent = parent;
                return [2 /*return*/];
    ...
    class_1.prototype.handleMouseOver = function (_e) {
        if (window.innerWidth >= 768) {
    ...
    class_1.prototype.isType = function (type) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    class_1.prototype.registerChildren = function () {
        var _this = this;
        if (this.type == NavItemTypeEnum.SUBNAV) {
