...
var TreeviewComponent = /** @class */ (function () {
     ...
     * Public Methods API
     */
    class_1.prototype.getTreeitems = function () {
    ...
    class_1.prototype.updateExpandedTreeitems = function (treeitems, targetNodes, expanded) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.resolve(treeitems.map(function (node) { return targetNodes.indexOf(node) != -1
                        ? new Treeitem(__assign(__assign({}, node), { expanded: typeof (expanded) == "boolean" ? expanded : !node.expanded }))
                        : node; }))];
            });
        });
    };
    class_1.prototype.updateVisibleTreeitems = function (treeitems, targetNodes, visible) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.resolve(treeitems.map(function (node) { return targetNodes.indexOf(node) != -1
                        ? new Treeitem(__assign(__assign({}, node), { visible: typeof (visible) == "boolean" ? visible : !node.visible }))
                        : node; }))];
            });
        });
    };
    class_1.prototype.updateFocusedTreeitems = function (treeitems, targetNodes, focused) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.resolve(treeitems.map(function (node) {
                        ...
                        return targetNodes.some(idEquals)
                            ? new Treeitem(__assign(__assign({}, node), { focused: typeof (focused) == "boolean" ? focused : !node.focused }))
                            : (node.focused)
                                ? new Treeitem(__assign(__assign({}, node), { focused: false }))
                                : node;
                    }))];
            });
        });
    };
    class_1.prototype.updateSelectedTreeitems = function (treeitems, targetNodes, selected) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.resolve(treeitems.map(function (node) {
                        var idEquals = function (targetNode) { return targetNode.id === node.id; };
                        return targetNodes.some(idEquals) ? new Treeitem(__assign(__assign({}, node), { selected: typeof (selected) == "boolean" ? selected : !node.selected }))
                            : (node.selected)
                                ? new Treeitem(__assign(__assign({}, node), { selected: false }))
                                : node;
                    }))];
            });
        });
    };
    class_1.prototype.findNodeByProperty = function (key, value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    class_1.prototype.findNodeByUrlOrKey = function (value) {
        return this.treeitems.find(function (node) { return (node['key'] === value || node['url'] === value); });
    };
    class_1.prototype.selectNodeByUrlOrKey = function (url, childKey, emitEvent) {
    ...
    class_1.prototype.updateTreeView = function (structure) {
        return __awaiter(this, void 0, void 0, function () {
            var tree;
            return __generator(this, function (_a) {
     ...
     * Local Methods
     */
    class_1.prototype.initKeyboardEventProcessor = function () {
        var _this = this;
    ...
    class_1.prototype.moveSelection = function (evt, direction) {
        return __awaiter(this, void 0, void 0, function () {
            var nextSelectableNode, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    class_1.prototype.getNextSelectableNodeByFirstCharacter = function (treeitems, firstCharacter, direction) {
    ...
    class_1.prototype.getNextSelectableNode = function (treeitems, direction) {
    ...
    class_1.prototype.onClickCategory = function (evt) {
        return __awaiter(this, void 0, void 0, function () {
            var targetNode, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    class_1.prototype.onClickLink = function (treeitem, evt) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    class_1.prototype.toggleTreeitem = function (targetNode, expanded) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    class_1.prototype.onKeydown = function (evt) {
    ...
    class_1.prototype.onFocusin = function (_evt) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    class_1.prototype.getItemsFromTree = function (node, tree, parentNode) {
        var _this = this;
    ...
    class_1.prototype.buildTreeview = function (treeitems, idPrefix, parentId) {
        var _this = this;
