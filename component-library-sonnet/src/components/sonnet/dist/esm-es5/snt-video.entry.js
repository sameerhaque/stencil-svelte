...
var VideoComponent = /** @class */ (function () {
    ...
    class_1.prototype.processOembed = function () {
        return __awaiter(this, void 0, void 0, function () {
            var fullOembedUrl;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    class_1.prototype.getFullOembedUrl = function (shareUrl, oembedUrl, playUrl) {
        var uuid = shareUrl.match(/[^\/]+$/);
        var fullPlayUrl = playUrl + '/' + uuid;
        return oembedUrl + "?url=" + fullPlayUrl + "&format=json";
    };
    class_1.prototype.getDocumentFragmentFromHtmlString = function (htmlString) {
        var domParser = new DOMParser();
        return domParser.parseFromString(htmlString, 'text/html');
    };
    class_1.prototype.getPlayerScript = function (docFragment) {
    ...
    class_1.prototype.getPlayerEmbed = function (docFragment) {
