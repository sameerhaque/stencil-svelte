...
var SearchComboboxComponent = /** @class */ (function () {
    ...
    class_1.prototype.activeIndexChange = function (activeIndex) {
     ...
     * Listeners
     */
    class_1.prototype.onClick = function (evt) {
    ...
    class_1.prototype.setSearchSuggestions = function (suggestions) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (suggestions) {
    ...
    class_1.prototype.onInput = function (evt) {
    ...
    class_1.prototype.onListboxClick = function (evt) {
        if (evt.target) {
    ...
    class_1.prototype.selectItem = function () {
    ...
    class_1.prototype.updateSearchSuggestions = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
    ...
    class_1.prototype.setNextActiveIndex = function (direction) {
    ...
    class_1.prototype.highlightPattern = function (text, pattern) {
    ...
    ;
    class_1.prototype.submit = function () {
        this.selectItem();
        if (this.activeIndex != -1) {
    ...
    class_1.prototype.restoreUserInput = function () {
...
var SearchTypeaheadComponent = /** @class */ (function () {
    ...
    class_2.prototype.handleSearchButtonClick = function (evt) {
        if (evt.target == this.searchSntButton) {
            window.location.href = this.searchHref;
        }
    };
    class_2.prototype.onKeyDown = function () {
        window.location.href = this.searchHref;
    };
    ...
    class_2.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "search-input-area" }, h("snt-search-combobox", { ref: function (elem) { return (_this.searchComboBox = elem); }, id: this.searchComboboxId, class: "theme-neutral", "auto-complete": true, padding: "none", onSntInput: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
