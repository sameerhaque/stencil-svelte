...
const TestimonialsComponent = class {
    ...
    render() {
        if (this.single) {
            return (index.h(index.Host, { id: this.containerId, class: "carousel slide", "data-ride": "carousel" }, index.h("div", { class: "container" }, index.h("h2", { class: "testimonial-title" }, this.headline), index.h("div", { class: "carousel-inner" }, index.h("div", { class: "carousel-item active" }, index.h("div", { class: "carousel-caption " }, index.h("div", { class: "carousel-quote" }, index.h("blockquote", null, index.h("slot", null)), index.h("p2", null, this.from))))))));
        }
        else {
            return (index.h(index.Host, { class: "carousel-item", id: this.containerId }, index.h("div", { class: "carousel-caption" }, index.h("div", { class: "carousel-quote" }, index.h("blockquote", null, index.h("slot", null)), index.h("p2", null, this.from)))));
        }
    }
...
const TestimonialsGroupComponent = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.showSlide = index.createEvent(this, "showSlide", 7);
        this.hideSlide = index.createEvent(this, "hideSlide", 7);
        this.selected = 0;
    ...
    render() {
        ...
        return (index.h(index.Host, { id: this.groupId, class: "carousel slide", "data-ride": "carousel" }, index.h("div", { class: "full_container" }, index.h("snt-layout", null, index.h("h2", { class: "testimonial-title" }, this.groupHeadline), index.h("div", { class: "carousel-slider-wrap" }, index.h("div", { class: "carousel-inner" }, index.h("slot", null))), index.h("div", { class: "testimonial-controls " + (testimonials.length > 1 ? '' : 'd-none') }, index.h("a", { class: "carousel-control-prev", href: "javascript:void(0);", role: "button", "data-slide": "prev" }, index.h("span", { class: "carousel-control-prev-icon", "aria-hidden": "true" }, index.h("i", { class: "arrows left" })), index.h("span", { class: "sr-only" }, "Previous")), index.h("ol", { class: "carousel-indicators" }, testimonials.map((_elem, index$1) => index.h("li", { "data-target": "#" + this.groupId, "data-slide-to": index$1, class: (index$1 == 0) ? 'active' : '' }))), index.h("a", { class: "carousel-control-next", href: "javascript:void(0);", role: "button", "data-slide": "next" }, index.h("span", { class: "carousel-control-next-icon", "aria-hidden": "true" }, index.h("i", { class: "arrows right" })), index.h("span", { class: "sr-only" }, "Next")))))));
    }
    get element() { return index.getElement(this); }
};
TestimonialsGroupComponent.style = testimonialsComponentCss$1;

exports.testimonial_quote = TestimonialsComponent;
exports.testimonials_group = TestimonialsGroupComponent;
