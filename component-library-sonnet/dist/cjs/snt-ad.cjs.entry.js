...
const AdComponent = class {
    ...
    componentWillLoad() {
        if (StringUtils.StringUtils.hasValue(this.iconSources)) {
    ...
    render() {
        var content;
        if (this.logoIsSet) {
            content = (index.h("div", { class: "logo" }, index.h("picture", null, index.h("source", { "data-srcSet": this.logoSourceJson.extraLargeLogoUrl, media: "(min-width: 1440px)" }), index.h("source", { "data-srcSet": this.logoSourceJson.largeLogoUrl, media: "(min-width: 1024px)" }), index.h("source", { "data-srcSet": this.logoSourceJson.mediumLogoUrl, media: "(min-width: 768px)" }), index.h("source", { "data-srcSet": this.logoSourceJson.smallLogoUrl, media: "(min-width: 0px)" }), index.h("img", { class: "logo-image", src: "", "data-src": "", alt: "", "aria-hidden": "true" }))));
        }
        else if (this.iconIsSet) {
            content = (index.h("div", { class: "icon" }, index.h("picture", { class: "icon-image" }, index.h("source", { "data-srcSet": this.iconSourceJson.largeIconUrl, media: "(min-width: 1024px)" }), index.h("source", { "data-srcSet": this.iconSourceJson.smallIconUrl, media: "(min-width: 0px)" }), index.h("img", { class: "icon-image", src: "", "data-src": "", alt: "", "aria-hidden": "true" }))));
        }
        ...
        const titleContent = StringUtils.StringUtils.hasValue(this.titleString)
            ...
            : null;
        return (index.h(index.Host, null, index.h("snt-layout", null, index.h("div", { class: "ad-panel" }, content, titleContent, index.h("div", { class: WebUtils.WebUtils.generateClasses(["content"], this.styleClasses) }, index.h("slot", null)), buttonContent))));
    }
    buildButtonContent() {
        if (this.href && this.buttonLabel) {
            return (index.h("button-link-group", null, index.h("button-link", { href: this.href, target: this.target, "aria-label": this.ariaLabel }, this.buttonLabel)));
        }
        else if (this.actionReference && this.actionData && this.buttonLabel) {
            return (index.h("button-link-group", null, index.h("snt-action-button", { "action-reference": this.actionReference, "action-data": this.actionData, "style-classes": "cta", "link-title": this.buttonLabel })));
        }
        else if (this.linkLabel && this.href) {
            return (index.h("snt-link", { "class-names": "theme-link theme-action", "aria-label": this.linkLabel, href: this.href }, " ", index.h("span", { class: "link-content" }, this.linkLabel), "  "));
        }
        else {
            return null;
        }
