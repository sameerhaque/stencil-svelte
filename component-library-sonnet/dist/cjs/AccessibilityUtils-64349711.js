...
class AccessibilityUtils {
    ...
    static getNewWindowTitle() {
        return (LanguageUtils.LanguageUtils.current() == LanguageUtils.LanguageUtils.LANGUAGE_CODES.en) ? AccessibilityUtils.NEW_WINDOW_TITLE_EN : AccessibilityUtils.NEW_WINDOW_TITLE_FR;
    }
    static getNewWindowText() {
        return (LanguageUtils.LanguageUtils.current() == LanguageUtils.LanguageUtils.LANGUAGE_CODES.en) ? AccessibilityUtils.NEW_WINDOW_TEXT_EN : AccessibilityUtils.NEW_WINDOW_TEXT_FR;
    }
}
