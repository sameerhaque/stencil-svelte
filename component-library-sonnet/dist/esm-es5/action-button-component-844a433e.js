...
var ActionButtonComponent = /** @class */ (function () {
    function ActionButtonComponent(hostRef) {
    ...
    ActionButtonComponent.prototype.getEventConfiguration = function () {
    ...
    ActionButtonComponent.prototype.onSntButtonClick = function (event) {
        EventConfigurationUtils.processEvent(event, this.eventConfiguration, this.actionReference, this.actionDataJsonObj);
    };
    ActionButtonComponent.prototype.onSntButtonKeyDown = function (event) {
        EventConfigurationUtils.processEvent(event, this.eventConfiguration, this.actionReference, this.actionDataJsonObj);
    };
    ActionButtonComponent.prototype.componentDidLoad = function () {
    ...
    ActionButtonComponent.prototype.render = function () {
        var icon = (StringUtils.notEmpty(this.iconClassName)) ? h("snt-icon", { styleClasses: this.iconClassName }) : "";
        var button = h("snt-button", { "button-id": this.buttonId, styleClasses: WebUtils.generateClasses([], this.styleClasses), "hidden-title": this.linkTitle }, icon, this.linkTitle);
        var events = (this.element.children.length > 0) ? h("slot", null) : [h("snt-event", { type: "click" }), h("snt-event", { type: "keydown", filters: "space" })];
        return [events, button];
    };
    Object.defineProperty(ActionButtonComponent.prototype, "element", {
