...
var FeatureRightExample = /** @class */ (function () {
    function FeatureRightExample(hostRef) {
        registerInstance(this, hostRef);
        this.viewport = "";
    }
    FeatureRightExample.prototype.render = function () {
        return [
    ...
    return FeatureRightExample;
}());
FeatureRightExample.TAG_NAME = "feature-right-example";
export { FeatureRightExample as feature_right_example };
