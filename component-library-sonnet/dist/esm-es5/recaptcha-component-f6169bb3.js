...
var RecaptchaComponent = /** @class */ (function () {
    ...
    class_1.prototype.handleGrecaptchaLoaded = function () {
        if (window.grecaptcha && window.grecaptcha.render) {
            this.renderRecaptcha(window['grecaptcha']);
        }
    };
    class_1.prototype.loadRecaptchaScript = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    class_1.prototype.grecaptchaCallback = function (value) {
        this.checkbox.value = value;
        this.toggleChecked(this.checkbox, true);
    };
    class_1.prototype.grecaptchaExpiredCallback = function () {
        this.checkbox.value = "";
        this.toggleChecked(this.checkbox, false);
    };
    class_1.prototype.grecaptchaErrorCallback = function () {
        this.checkbox.value = "";
        this.toggleChecked(this.checkbox, false);
    };
    class_1.prototype.toggleChecked = function (checkbox, checked) {
        if (checked != checkbox.checked) {
            checkbox.click();
        }
    };
    class_1.prototype.renderRecaptcha = function (recaptcha) {
