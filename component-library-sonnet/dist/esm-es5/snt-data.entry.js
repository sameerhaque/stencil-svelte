...
import { A as AbstractUrlContentBuilder, H as HtmlContentBuilder } from './HtmlContentBuilder-f513c9f5.js';
var ContentData = /** @class */ (function () {
    function ContentData(type, lazy, url, content) {
...
var JsonUrlContentBuilder = /** @class */ (function (_super) {
    __extends(JsonUrlContentBuilder, _super);
    function JsonUrlContentBuilder() {
        return _super.call(this) || this;
    }
    JsonUrlContentBuilder.newInstance = function () {
        return new JsonUrlContentBuilder();
    };
    JsonUrlContentBuilder.prototype.withValue = function (value) {
        this.value = value;
        this.url = null;
        return this;
    };
    JsonUrlContentBuilder.prototype.build = function () {
    ...
    JsonUrlContentBuilder.prototype.parse = function (value) {
        return JSON.parse(value);
    };
    return JsonUrlContentBuilder;
}(AbstractUrlContentBuilder));
var ContentParser = /** @class */ (function () {
    function ContentParser() {
    }
    ContentParser.parse = function (value) {
        switch (value.type) {
            case ContentTypeEnum.HTML:
                var htmlBuilder = HtmlContentBuilder.newInstance();
            ...
            case ContentTypeEnum.JSON:
                var jsonBuilder = JsonUrlContentBuilder.newInstance();
...
var DataComponent = /** @class */ (function () {
    function DataComponent(hostRef) {
        registerInstance(this, hostRef);
    }
    DataComponent.prototype.getData = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.builder.build()];
            });
        });
    };
    DataComponent.prototype.componentWillLoad = function () {
        var url = (this.src ? new URL(this.src) : null);
        this.builder = ContentParser.parse(new ContentData(ContentTypeEnum.findByValue(this.type), this.lazyLoad, url, this.data));
    };
    DataComponent.prototype.render = function () {
        return (h(Host, null));
    };
    Object.defineProperty(DataComponent.prototype, "element", {
