...
var AccordionGroupComponent = /** @class */ (function () {
    ...
    class_1.prototype.expandAll = function () {
    ...
    class_1.prototype.collapseAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            var children;
            return __generator(this, function (_a) {
    ...
    class_1.prototype.addAccordion = function (accordion) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    class_1.prototype.onAccordionEvent = function (event) {
        if ((event.detail.state == AccordionStateEnum.EXPANDED) && (!(this.multiExpand))) {
            this.collapseSibling(event);
        }
    };
    class_1.prototype.collapseSibling = function (event) {
