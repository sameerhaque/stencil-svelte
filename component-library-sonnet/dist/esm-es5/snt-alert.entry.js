...
var AlertsBanner = /** @class */ (function () {
    ...
    AlertsBanner.prototype.dismiss = function () {
    ...
    AlertsBanner.prototype.componentWillLoad = function () {
        this.setShowFadeState();
        this.checkCookies();
        this.checkIE11();
    };
    AlertsBanner.prototype.render = function () {
        var _a;
